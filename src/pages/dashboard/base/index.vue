...
export default {
  ...
  watch: {
    brandTheme(val) {
      changeChartsTheme([this.refundChart, this.countChart, this.monitorChart, this.stokeChart], val);
    },
    mode(val) {
      changeChartsTheme([this.moneyCharts, this.refundChart, this.countChart, this.monitorChart, this.stokeChart], val);
      this.renderCharts();
    },
  },
  mounted() {
